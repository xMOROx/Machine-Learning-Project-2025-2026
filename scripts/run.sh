...
print_usage() {
  ...
  echo "  --ups             Upsampling factor (default: ${UPS})"
  echo "  --lr              Learning rate for distillation (default: ${LR})"
  ...
  echo ""
  echo "HTP options:"
  echo "  --method          SSL method: mocov2, byol, dino (default: ${METHOD})"
  echo "  --backbone        Backbone: resnet50, bcosresnet50 (default: ${BACKBONE})"
  echo "  --probe-type      Probe type: linear, bcos-1, std-2, etc. (default: ${PROBE_TYPE})"
