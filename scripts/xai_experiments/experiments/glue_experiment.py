...
class GLUEExperiment:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.output_dir = config.get("output_dir", "./outputs/xai_experiments/glue_sst2")
    ...
    def prepare_data(self) -> Tuple[DataLoader, DataLoader]:
        ...
        self.test_texts = val_texts[:100]  # Use subset for faster testing
    ...
    def generate_integrated_gradients(
        ...
        sample_indices = np.random.choice(
            len(self.test_texts),
            min(num_samples, len(self.test_texts)),
            replace=False
        )
        ...
        for i, idx in enumerate(tqdm(sample_indices)):
            ...
            try:
                ...
                sample_result = {
                    ...
                    "tokens": tokens[:50],  # Limit for storage
                    "top_attributions": []
                }
                ...
                if valid_indices:
                    ...
                    sorted_attrs = sorted(valid_attrs, key=lambda x: abs(x[1]), reverse=True)
    ...
    def run_full_pipeline(self) -> Dict[str, Any]:
        ...
        # Step 4: Generate Integrated Gradients
