...
class ModelComparison:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.output_dir = config.get(
            "output_dir", "./outputs/xai_experiments/model_comparison"
        )
    ...
    def train_random_forest(self) -> Dict[str, Any]:
        ...
        print(
            f"[Random Forest] Train Acc: {train_acc:.2f}%, Test Acc: {test_acc:.2f}%, Time: {training_time:.1f}s"
        )
    ...
    def train_lightgbm(self) -> Dict[str, Any]:
        ...
        print(
            f"[LightGBM] Train Acc: {train_acc:.2f}%, Test Acc: {test_acc:.2f}%, Time: {training_time:.1f}s"
        )
    ...
    def train_svm(self) -> Dict[str, Any]:
        ...
        model = SVC(kernel=kernel, C=C, random_state=42, cache_size=2000)
        ...
        print(
            f"[SVM] Train Acc: {train_acc:.2f}%, Test Acc: {test_acc:.2f}%, Time: {training_time:.1f}s"
        )
    ...
    def train_logistic_regression(self) -> Dict[str, Any]:
        ...
        model = LogisticRegression(
            max_iter=max_iter, n_jobs=-1, random_state=42, solver="saga"
        )
        ...
        print(
            f"[Logistic Regression] Train Acc: {train_acc:.2f}%, Test Acc: {test_acc:.2f}%, Time: {training_time:.1f}s"
        )
    ...
    def train_cnn(self, model_type: str = "simple") -> Dict[str, Any]:
        ...
        print(
            f"[CNN-{model_type}] Train Acc: {train_acc:.2f}%, Test Acc: {test_acc:.2f}%, Time: {training_time:.1f}s"
        )
    ...
    def run_comparison(self) -> Dict[str, Any]:
        ...
        for _, result in sorted_results:
            if "error" not in result:
                print(
                    f"{result['model']:<25} {result['train_accuracy']:<12.2f} {result['test_accuracy']:<12.2f} {result['training_time']:<10.1f}"
                )
